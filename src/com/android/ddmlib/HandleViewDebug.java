...
public final class HandleViewDebug extends ChunkHandler {
    ...
    public static void captureLayers(Client client, String viewRoot,
    ...
    private static void sendViewOpPacket(Client client, int op, String viewRoot,
            String view, byte[] extra, ViewDumpHandler handler)
                    throws IOException {
        int bufLen = 4 +                        // opcode
    ...
    public static void profileView(Client client, String viewRoot,
            String view, ViewDumpHandler handler) throws IOException {
        sendViewOpPacket(client, VUOP_PROFILE_VIEW, viewRoot, view, null, handler);
    }

    public static void captureView(Client client, String viewRoot,
            String view, ViewDumpHandler handler) throws IOException {
        sendViewOpPacket(client, VUOP_CAPTURE_VIEW, viewRoot, view, null, handler);
    }

    public static void invalidateView(Client client, String viewRoot,
            String view) throws IOException {
        invokeMethod(client, viewRoot, view, "invalidate");
    }

    public static void requestLayout(Client client, String viewRoot,
            String view) throws IOException {
    ...
    public static void invokeMethod(Client client, String viewRoot,
            String view, String method, Object... args) throws IOException {
    ...
    public static void setLayoutParameter(Client client, String viewRoot,
            String view, String parameter, int value) throws IOException {
